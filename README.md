...
| selectionMode      | string        | Optional          | The selection behavior of the calendar. Support two options for now. Default selection mode is 'twoClick', where the selected start date and end date is cleared out every time the user try a new selection. The other mode is 'lastSelectedDate', where the cursor will jump based on the previous selected date.                                                                                                                                                                                                                                                                                                                                                                                                             |
